...
public class ListenerOthersTest extends BaseTest implements ITestListener {
    private static int countWorking, countSuccess, countSkipped, countFailed;
    private static final Logger LOGGER = LoggerFactory.getLogger(ListenerOthersTest.class);
    ...
    public void onTestSuccess(ITestResult result) {
        LOGGER.info("Testcase: " +  result.getName() + " - Status : Passed");
        countSuccess += 1;
    }

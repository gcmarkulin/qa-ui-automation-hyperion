...
public class Utility
{
    ...
    public static void analyzeLog(WebDriver driver, String name, String browser) {
        int countSevere = 0;
        ...
        if (browser.equals("chrome")) {
            try {
                ...
                if (logEntries.getAll().size() == 0) {
                    LOGGER.info("********* No Severe Errors on Browser Console *********");
                }
                else {
                    if (logEntries.getAll().size() > 0) {
                        ...
                        if (countSevere > 0) {
                            ...
                            String folderPath = System.getProperty("user.dir") + getFolderOS() + name+ "_" + date + ".html";
                ...
                LOGGER.error("Exception while saving the logs: " + e.getMessage());
            }
        }
    }
}
